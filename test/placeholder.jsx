...
describe('placeholder', function () {
  ...
  it('handles a placeholder (literal)', () => {
    ...
    expect(data1[0].completion[0].descriptor).to.equal('test')
    ...
    expect(data2[0].completion[0].descriptor).to.equal('test')
    ...
    expect(data3[0].suggestion[0].descriptor).to.equal('test')
    ...
    expect(data4[0].suggestion[0].descriptor).to.equal('test')
