...
Parser.prototype.understand = function(grammar) {
  var scope = grammar.scope;
  var phrases = grammar.phrases;
  // var dependencies = grammar.dependencies;
  var elementFactory;
  var i;
  ...
  for (i = 0; i < l; i++) {
    ...
    this.phrases.push(new Phrase(phrases[i], scope, elementFactory));
  }
  return this;
};
