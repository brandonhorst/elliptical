...
var InputOption = function(options, text, match, suggestion, completion, result) {
...
InputOption.prototype.handleValue = function(id, value) {
  ...
  return new InputOption(this.options, this.text, this.match, this.suggestion, this.completion, newResult);
};
...
InputOption.prototype.handleString = function(string, partOfSpeech) {
  ...
  return new InputOption(this.options, newText, newMatch, newSuggestion, newCompletion, newResult);
};
