...
var InputOption = function(id, options, text, match, suggestion, completion, result, stack) {
  this.id = id;
...
InputOption.prototype.stackPush = function (element) {
  ...
  return new InputOption(this.id, this.options, this.text, this.match, this.suggestion, this.completion, this.result, newStack);
};
...
InputOption.prototype.handleValue = function(id, value) {
  ...
  return new InputOption(this.id, this.options, this.text, this.match, this.suggestion, this.completion, newResult, this.stack);
};
...
InputOption.prototype.handleString = function(string, category) {
  ...
  return new InputOption(this.id, this.options, newText, newMatch, newSuggestion, newCompletion, newResult, this.stack);
};
